...
# ================================================
# YA 1.3 Tasa de mortalidad por Infección Respiratoria Aguda (IRA) en menores de 5 años
# ================================================
...
class(YA_1.3$anno)
class(YA_1.3$IRA) # Podemos hacerlo paara cada una de las variables
...
YA_1.3_VF <- YA_1.3_VF %>% 
  mutate(tasa_IRA = (IRA / total_menores_5) * 1000)
